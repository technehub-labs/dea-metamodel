...
│   ├── maturity-scales.md                      ← CR-AM-09 Phase 1 governance (model-owned scales + topology/function independence)
...
│   ├── scale-examples/                          ← CR-AM-09 Phase 1 worked maturity-scale examples
