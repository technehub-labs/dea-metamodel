...
| [CR-AM-05](CR-AM-05.md) | Assessment Views & Aggregation | Establishes the canonical AssessmentView + AggregationModel layer. Capability profile, scenario profile, enterprise heatmap, and trend views are derived projections over AssessmentResults; missing data is N/A, not zero; score and maturity aggregation are distinct. | Proposed |
