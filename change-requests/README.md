...
| [CR-AM-07](CR-AM-07.md) | Comparative Benchmarking & Peer Analytics | Answers "how do we compare it?" — BenchmarkComparison as a reproducible derivation over an admitted BenchmarkCohort: cohort distribution, percentile, rank, peer position (4/27). Consumes CR-AM-06 eligibility without redefining it; insight/narrative layer parked for CR-AM-08. Parent: CR-AM-01. | In progress (Phase 1 comparison vocabulary & schema implemented; Phases 2–4 Proposed) |
