...
| [CR-AM-03](CR-AM-03.md) | Assessment Catalog Migration & Integration | Migrates Technology, Modernization, Operations and Services Delivery from legacy instruments to canonical AssessmentModels, executions, results, migration manifests, coverage matrix, and a discoverable portfolio. Parent: CR-AM-02. | Proposed |
