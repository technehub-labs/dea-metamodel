...
| [CR-AM-07](CR-AM-07.md) | Comparative Benchmarking & Peer Analytics | Answers "how do we compare it?" — BenchmarkComparison as a reproducible derivation over an admitted BenchmarkCohort: cohort distribution, percentile, rank, peer position (4/27). Consumes CR-AM-06 eligibility without redefining it; insight/narrative layer parked for CR-AM-08. Parent: CR-AM-01. | In progress (Phase 1 vocabulary & schema + Phase 2 distribution engine + Phase 3 percentile & ranking implemented; Phase 4 Proposed) |
...
| [CR-CM-000](CR-CM-000.md) | Terminology Alignment | Reserves `Domain`/`Stage` for the Enterprise Concept Framework; introduces Concept Area, Concept Profile, Concept Classification, and ECF Context for the OpenDEA Concepts Model; lands the terminology registry (`vocabulary/terminology-registry.yaml`) before the first canonical Concepts Model | Implemented (docs + registry; no canonical version bump) |
