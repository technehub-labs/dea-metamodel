...
| [CR-AM-06](CR-AM-06.md) | Benchmark Model & Eligibility | Establishes benchmark eligibility as a governed determination: six-state status vocabulary, machine-actionable reason codes, canonical comparability key, and BenchmarkCohort as a population construct. No ranking — percentile/rank/peer-position belong to CR-AM-07. | Proposed |
