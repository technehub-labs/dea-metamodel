...
class Process(Entity):
    ...
    process_audience: Literal['governance-existence', 'strategy-direction', 'agency-organization', 'party-relationship', 'product-value', 'enablement-operations', 'finance-accounting']
